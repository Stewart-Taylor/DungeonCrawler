...
namespace DungeonCrawl.Engine.Characters
{
    class Wraith : Character
    {
        ...
        private String texturePath = "Characters//Wraith";
        ...
        public Wraith(Director d, Vector2 pos) : base(d, pos)
        {
            director = d;
        ...
        public override void update()
        {
            if (isDead == false)
            {
                director.getEffectManager().addFog(position, 1, Color.Black, false);
                mainUpdate();
                aiManager.update();
                updateBody();
                attackUpdate();
        ...
        private void updateDead()
        {
            ...
            if (moveTimer <= moveLimit /4)
            {
                ...
                if (Director.random.Next(100) < 20)
                {
                    ...
                    Treasure t = new Treasure(director,new Vector2(position.X + Director.random.Next(-100, 100), position.Y + Director.random.Next(-100, 100)));
