...
namespace DungeonCrawl.Engine
{
    class InputManager
    {
        ...
        private void testInput()
        {
            ...
            {
                ///   director.getEffectManager().addFlame(new Vector2(input.MousePosition.X + director.camera.Pos.X - (500), input.MousePosition.Y + +director.camera.Pos.Y - (350)), 10);


               //    director.getEffectManager().addFlame(director.getPlayer().getPosition(), 10, director.getPlayer().getRotation(), director.getPlayer().getSpeed());
        ...
        private void updateCamera()
        {
            ...
            {
               // director.getCamera().Pos = new Vector2(director.getPlayer().getPosition().X, director.getPlayer().getPosition().Y);
